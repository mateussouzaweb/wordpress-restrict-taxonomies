    ...
    public function posts() {
        ...
        if( is_array( $settings_user ) && !empty( $settings_user[ $user_login ] ) ){
            ...
            foreach ( $user_cap as $cap ) {
                // All user role id is appended with _taxonomies
                // This is project convention and to verify if a term must be shown we it it
                $cap .= '_taxonomies';
    ...
    public function show($settings, $options, $options_name){
        ...
        foreach( $options as $_key => $_value ): ?>
            ...
            foreach( $_value['options'] as $key => $value ):
                ...
                // Here is necessary the use of 'id' because the verification is made by the user role id,
                    ...
                    <div class="postbox">
                        ...
                        <div class="inside" style="display:none; padding:0 10px;">
                            <ul class="taxonomychecklist form-no-clear">
                                <?php // Sending to list_taxonomy_options the $id and not $_value['name'] ?>
                                <?php echo $this->list_taxonomy_options($key, $options_name, $id, $selected); ?>
                            </ul>
